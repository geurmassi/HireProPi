...
public class RecruteurCandidatureController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        int id = UserConnect.idUserConnect;
       // String labelValueUser = iduserm;
                ...
                comboBoxOffre.setOnAction(event -> {
                    ...
                    ObservableList<Condidature> liste = FXCollections.observableList(cm.getCandidaturesByPosteEnAttente(selectedPoste));
    ...
    private void updateEtat(ActionEvent event) {
        ...
        if (selectedCondidature != null && selectedEtat != null) {
            ...
            if (!selectedEtat.equals(previousEtat)) {
                ...
                } else if (selectedEtat == EtatCandidature.accepté) {

...
import edu.connection.services.UserMETIER;
        ...
        if (u.getId() != 0 && u.getNom() != null && u.getPrenom() != null && u.getAdresse() != null
            ...
            if (userRole != null) {
                if (userRole.equals("candidat")) {
                    ...
                    AfficherOffreController apc = loader.getController();
                    apc.setLabelIdUserValue(lidu.getText());
                    apc.setLabelRoleUserValue(userRole);
                    apc.initialize(null, null);

...
import edu.connection.api.PDFCreator;
 ...
 * @author samsung
 */
public class ReclamationInactiveController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        reclamationInstance = FXCollections.observableList(rm.displayEntitiesInactive());
        ...
        int count1 = rm.conterReclamationInactive();
        lbcount1.setText("Total Reclamation Inactives : " + count1);
    }    

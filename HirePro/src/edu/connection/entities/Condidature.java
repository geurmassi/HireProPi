...
public class Condidature {
    ...
    public Condidature(int idC, String cv, String lettreMotivation, Timestamp dateCandidature, int idUtilisateur, int idOffre, String portfolio, EtatCandidature etat) {
        this.idC = idC;
        this.cv = cv;
        this.lettreMotivation = lettreMotivation;
        this.dateCandidature = dateCandidature;

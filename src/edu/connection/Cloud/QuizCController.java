...
public class QuizCController implements Initializable {
   ...
   public void initialize(URL url, ResourceBundle rb) {
    ...
    private int calculateScore() {
        ...
        if (FT_R12.isSelected() && FT_R24.isSelected() && FT_R32.isSelected() && FT_R42.isSelected()) {
            score = 4;
        } else if ((FT_R12.isSelected() && FT_R24.isSelected() && FT_R32.isSelected()) || (FT_R12.isSelected() && FT_R24.isSelected() && FT_R42.isSelected())
                || (FT_R12.isSelected() && FT_R32.isSelected() && FT_R42.isSelected()) || (FT_R24.isSelected() && FT_R32.isSelected() && FT_R42.isSelected())) {
            score = 3;
        } else if ((FT_R12.isSelected() && FT_R24.isSelected()) || (FT_R12.isSelected() && FT_R32.isSelected()) || (FT_R12.isSelected() && FT_R42.isSelected())
                || (FT_R24.isSelected() && FT_R32.isSelected()) || (FT_R24.isSelected() && FT_R42.isSelected()) || (FT_R32.isSelected() && FT_R42.isSelected())) {
            score = 2;
        } else if (FT_R12.isSelected() || FT_R24.isSelected() || FT_R32.isSelected() || FT_R42.isSelected()) {
            score = 1;
        }
    ...
    private void showCorrectAnswer() {
        ...
        FT_R24.setSelected(true);
        FT_R24.setStyle("-fx-background-color: green;");
        FT_R32.setSelected(true);
        FT_R32.setStyle("-fx-background-color: green;");
        FT_R42.setSelected(true);
        FT_R42.setStyle("-fx-background-color: green;");
    }
}
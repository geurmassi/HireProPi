...
public class NewFXMain extends Application {
    ...
    public void start(Stage primaryStage) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/edu/connection/Web/Home.fxml"));
        ...
        playquizbtn.setOnAction((ActionEvent event) -> {
            try {
                ...
                fxmlLoader = new FXMLLoader(getClass().getResource("/edu/connection/Web/QuizC.fxml"));
